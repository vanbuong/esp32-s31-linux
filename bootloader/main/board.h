 ...
 */
#if defined(BOARD_FUNCTION_COREBOARD_1_SPI_SD)
#define BOARD_NAME			"ESP32-S31-Function-CoreBoard-1 (SPI SD)"
#define BOARD_HAS_SD_POWER_EN		0
#define BOARD_HAS_SDMMC			0
#define BOARD_HAS_SPI_SD		1
...
#define BOARD_SPI_SD_PIN_MISO		20
#define BOARD_SPI_SD_PIN_CS		23

/*
 * SPI ILI9341 wiring on free J2 pins (Ethernet owns GPIO5-19, SPI SD owns
 * GPIO20/23/24/25, USB Serial/JTAG owns GPIO33/34).
 */
...
#else
#error "Unknown BOARD; set BOARD=korvo-1, function-coreboard-1, or function-coreboard-1-spi-sd"
#endif
